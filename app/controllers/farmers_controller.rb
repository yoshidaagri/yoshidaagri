class FarmersController < ApplicationController
  ...
  private
    ...
    def farmer_params
      params.require(:farmer).permit(:user_id, :farmer_flg, :farm_name, :catchcopy, :representative, :management_content, :farm_banner, :farm_area, :zipcode, :address, :access, :tel, :fax, :twitter, :facebook, :googlemap)
    end
end
